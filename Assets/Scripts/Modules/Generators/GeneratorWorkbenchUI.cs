...
public class GeneratorWorkbenchUI : MonoBehaviour, IWorkbenchUI
{
    ...
    private void DrawWindow(int id)
    {
        ...
        GUILayout.Label($"<color=#AAAAAA>Параметры Ве��стака:</color> Тир {controller.workbenchTier} | Вместимость: {controller.innerLength}×{controller.innerHeight}×{controller.innerWidth} м",
